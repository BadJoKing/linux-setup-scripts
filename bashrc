...
alias searchrep='paru -Ss --repu'
alias search='paru -Ss'
alias searchaur='paru -Ss --aur'
alias getrep='paru -S --repo'
alias getaur='paru -S --aur'
alias tf='bash /home/terryblejokes/TorrentFinder/TF.sh'
alias cmdstats="history | awk '{print $2}' | sort | uniq -c | sort -rn | head -5"
alias make='make -j $(nproc)'
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/local/sbin:/opt/android-sdk/emulator:/opt/cuda/bin:/opt/cuda/nsight_compute:/opt/cuda/nsight_systems/bin:/var/lib/flatpak/exports/bin:/usr/lib/jvm/default/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:'/home/terryblejokes/.local/bin':/root/.local/share/gem/ruby/3.0.0/bin:/home/terryblejokes/.rbenv/versions/3.0.0/bin/
. "$HOME/.cargo/env"
